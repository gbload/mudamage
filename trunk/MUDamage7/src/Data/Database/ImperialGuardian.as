package Data.Database{
	public class ImperialGuardian{
		...
		private var monster:Array = [
			["カウンターリベリオン","ガイオンガード",1,570,30,35,18,0,0],
			["カウンターリベリオン","ガイオンナイト",1,550,28,33,17,0,0],
			["カウンターリベリオン","ガイオンプリースト",1,500,25,30,15,0,0],
			["カウンターリベリオン","ガイオンディフェンダー",1,580,30,35,20,0,0],
			
			["カウンターリベリオン","ビーストマスター",1,650,33,38,22,0,0],
			["カウンターリベリオン","アサシンマスター",1,650,33,38,22,0,0],
			["カウンターリベリオン","マジックマスター",1,650,33,38,22,0,0],
			["カウンターリベリオン","アーティクルマスター",1,650,33,38,22,0,0],
			["カウンターリベリオン","コンバットマスター",1,650,33,38,22,0,0],
			["カウンターリベリオン","クォーターマスター",1,650,33,38,22,0,0],
			
			["カウンターリベリオン","第一師団長 月光のデスラー",1,780,36,41,27,0,0],
			["カウンターリベリオン","第二師団長 烈火のベルモント",1,780,36,41,27,0,0],
			["カウンターリベリオン","第三師団長 激流のカト",1,780,36,41,27,0,0],
			["カウンターリベリオン","第四師団長 疾風のガリア",1,780,36,41,27,0,0],
			["カウンターリベリオン","軍団長 大地のエルカン",1,800,39,44,28,0,0],
			["カウンターリベリオン","副司令官 雷撃のレイモンド",1,800,39,44,28,0,0],
			["カウンターリベリオン","参謀長 漆黒のジェリント",1,930,42,47,30,0,0],
			
			["カウンターリベリオン","ガイオン・カレイン",1,1250,45,50,35,0,0],
		];
		/**
		 * モンスターレベルの乗数<br>
