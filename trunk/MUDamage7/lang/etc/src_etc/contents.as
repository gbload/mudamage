...
click function jobChange(event:Event):void{
	...
	//ダークロードの場合、鷹を表示する
	if(d.f_job.selectedLabel == "Dark Lord")
		d.f_left.f_kind.dataProvider = ["None","Normal","てすちゅ","Set Ancient","Socket","EXE Socket","Dark Raver"];
	else
		d.f_left.f_kind.dataProvider = ["None","Normal","てすちゅ","Set Ancient","Socket","EXE Socket"];
