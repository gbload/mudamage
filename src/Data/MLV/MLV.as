package MuCalc
{
	...
	public class MLV
	{
		...
		//共通=========================================
		//防御向上
		static public var inf_pvpavoid:Array = ["対人防御成功率",600,1300,2100,3000,4000];
		static public var inf_poison_resist:Array = ["毒抵抗力",1,2,3,4,5];//%
		static public var inf_lightning_resist:Array = ["稲妻抵抗力",1,2,3,4,5];//%
		static public var inf_ice_resist:Array = ["氷抵抗力",1,2,3,4,5];//%
		static public var inf_def:Array = ["防御力上昇",50,100,150,200,250];
		static public var inf_sd:Array = ["最大SD上昇",300,450,600,750,900];
		static public var inf_sd_heal:Array = ["SD回復速度上昇(%)",10,20,30,40,50];//%
		//スキル強化
		static public var inf_hit:Array = ["攻撃成功率上昇",400,900,1600,2700,4400];
		static public var inf_hp:Array = ["最大HP上昇",50,100,150,200,300];
		static public var inf_ag:Array = ["最大AG上昇",60,120,180,240,300];
		//攻撃力向上
		static public var inf_pvphit:Array = ["対人攻撃成功率",1000,2300,4000,6500,10000];
		static public var inf_monster_hp:Array = ["モンスターkill時生命回復(生命/)",40,20,14,10,8];
		static public var inf_monster_mana:Array = ["モンスターkill時マナ回復(マナ/)",40,20,14,10,8];
		static public var inf_monster_sd:Array = ["モンスターkill時SD回復(SD/)",7,6,5,4,3];
		static public var inf_max_attack:Array = ["最大攻撃力上昇",10,20,30,40,50];
		static public var inf_min_attack:Array = ["最小攻撃力上昇",8,16,24,32,40];
		static public var inf_max_magic:Array = ["最大魔力上昇",10,20,30,40,50];
		static public var inf_min_magic:Array = ["最小魔力上昇",8,16,24,32,40];
		static public var inf_max_attack_magic:Array = ["最大攻撃力/魔力上昇",10,20,30,40,50];
		static public var inf_min_attack_magic:Array = ["最小攻撃力/魔力上昇",8,16,24,32,40];
		//成長・凡庸
		static public var inf_endurance1:Array = ["耐久減少1(%)",20,40,60,80,100];//%
		static public var inf_endurance2:Array = ["耐久減少2(%)",20,40,60,80,100];//%
		static public var inf_ah:Array = ["AH(%)",1,2,3,4,5];//%
		static public var inf_zen:Array = ["ゼン増加(%)",40,80,120,160,200];//%
		static public var inf_exp:Array = ["経験値上昇(%)",8,16,24,32,40];//%
		static public var inf_mana_dec:Array = ["消費マナ減少(%)",5,10,15,20,25];//%
		static public var inf_pet_endurance:Array = ["ペット耐久減少",100,200,300,400,500];
		//ナイト
		static public var inf_sl:Array = ["スウェルライフ強化(%)",
		...
		static public var inf_tc:Array = ["トルネードクラッシュ強化",
		...
		static public var inf_gb:Array = ["ゴッドブロー強化",
		...
		static public var inf_oi:Array = ["オメガインパクト強化",
		...
		//ウィザード
		static public var inf_sb:Array = ["ソウルバリア強化(%)",
		...
		static public var inf_hell_fire:Array = [	"ヘルファイア強化",
		...
		static public var inf_soul_the_end:Array = [	"ソウルジエンド強化",
		...
		static public var inf_sudden_ice:Array = ["サドゥンアイス強化",
		...
		//エルフ
		static public var inf_h:Array = [	"ヒール強化(%)",
		...
		static public var inf_midareuti:Array = [	"乱れ撃ち強化",
		...
		static public var inf_g:Array = [	"ガードプラス強化(エナ/)",
		...
		static public var inf_a:Array = [	"アタックプラス強化(エナ/)",
		...
		//魔剣士
		static public var inf_tc_ma:Array = [	"トルネードクラッシュ強化",
		...
		static public var inf_shining_blast:Array = [	"シャイニングブラスト強化",
		...
		static public var inf_soul_the_end_ma:Array = [	"ソウルジエンド強化",
														{skill:5,mana:99,ag:0,range:0},
														{skill:10,mana:108,ag:0,range:0},
														{skill:15,mana:117,ag:0,range:0},
														{skill:20,mana:126,ag:0,range:0},
														{skill:25,mana:135,ag:0,range:0}];
		static public var inf_ba:Array = ["ブラッドアタック強化",
		...
		static public var inf_ps:Array = ["パワースラッシュ強化",
		...
		//ダークロード
		static public var inf_earth_shake:Array = [	"アースシェイク強化",
		...
		static public var inf_fb:Array = ["ファイアバースト強化",
		...
		static public var inf_fs:Array = ["ファイアスクリーム強化",
		...
		//召喚師
		static public var inf_life:Array = [	"ライフドレイン強化",
		...
		static public var inf_sleep:Array = [	"スリープ強化",
													{skill:0,mana:0,ag:0,range:0},
													{skill:0,mana:0,ag:0,range:0},
													{skill:0,mana:0,ag:0,range:0},
													{skill:0,mana:0,ag:0,range:0},
													{skill:0,mana:0,ag:0,range:0}];
		static public var inf_chain:Array = [	"チェーンライトニング強化",
		...
		static public var inf_light:Array = [	"ライトニングショック強化",
		...
		public function tool(a:Array):String{
			...
			for(var i:int=1;i<=5;i++){
				if(a[i].skill)str += " 威力:+" + a[i].skill;
				if(a[i].mana)str += " 消費マナ:" + a[i].mana;
				if(a[i].ag)str += " 消費AG:" + a[i].ag;
				if(a[i].range)str += " 範囲:" +  a[i].range;
				if(a[i].damage)str += " ダメージ増加:" + a[i].damage;
				str += "\n";
			}
			return str;
		}
