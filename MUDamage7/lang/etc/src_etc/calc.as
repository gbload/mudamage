...
calc function equipExop(item:Item):Boolean{
	use namespace calc;
	if(!(item.f_kind.selectedLabel == "てすちゅ" || item.f_kind.selectedLabel == "EXE Socket"))return false;
...
calc function getForm():void{
	...
	if(d.f_right.f_kind.selectedLabel != "None"){
		if(d.f_right.f_kind.selectedLabel == "てすちゅ")
	...
	if(d.f_left.f_kind.selectedLabel != "None" && d.f_left.f_item.selectedItem[0] == "Weapon"){
		if(d.f_left.f_kind.selectedLabel == "てすちゅ")
	...
	//EXOP
	if(d.f_right.f_kind.selectedLabel == "てすちゅ" || d.f_right.f_kind.selectedLabel == "EXE Socket"){
	...
	//EXOP左手
	if(d.f_left.f_kind.selectedLabel == "てすちゅ" || d.f_left.f_kind.selectedLabel == "EXE Socket"){
	...
	//EXOPアクセ
	if(d.f_neck.f_kind.selectedLabel == "てすちゅ" || d.f_neck.f_kind.selectedLabel == "EXE Socket"){
