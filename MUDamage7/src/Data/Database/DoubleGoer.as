package Data.Database{
	public class DoubleGoer{
		...
		private var monster:Array = [
			["ドッペルゲンガー","召喚師",14,500,65,70,30,0,0],
			["ドッペルゲンガー","ダークロード",17,900,85,90,55,0,0],
			["ドッペルゲンガー","魔剣士",14,500,65,70,30,0,0],
			["ドッペルゲンガー","ウィザード",14,500,65,70,30,0,0],
			["ドッペルゲンガー","ナイト",14,500,65,70,30,0,0],
			["ドッペルゲンガー","エルフ",14,500,65,70,30,0,0],
			["ドッペルゲンガー","ブービーワーム",15,600,80,85,45,0,0],
			["ドッペルゲンガー","槌の子",16,1000,75,80,55,0,0],
			["ドッペルゲンガー","ディメンジョンウォーカー",19,1500,85,90,60,0,0],
			["ドッペルゲンガー","ディメンジョンプリズナー",18,2000,110,120,73,0,0],
			["ドッペルゲンガー","破壊の化身",20,2500,125,135,83,0,0]
		];
		/**
		 * モンスターレベルの乗数<br>
